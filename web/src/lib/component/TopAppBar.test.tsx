...
describe('TopAppBar', () => {
    ...
    it('renders AppBar with title, menu and children', () => {
        const component = shallow(<TopAppBar title={title}><div id='children' /></TopAppBar>);
    ...
    it('renders AppBar without title', () => {
        const component = shallow(<TopAppBar><div id='children' /></TopAppBar>);
    ...
    it('displays menu when button is clicked', () => {
        const component = shallow(<TopAppBar title={title} />);
