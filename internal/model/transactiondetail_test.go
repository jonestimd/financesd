...
func Test_GetRelatedDetail(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			detail := &TransactionDetail{TransactionDetail: &database.TransactionDetail{RelatedDetailID: test.relatedID}, txSource: test.txSource}
...
func Test_GetRelatedTransaction(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			detail := &TransactionDetail{TransactionDetail: &database.TransactionDetail{TransactionID: id}, txSource: test.txSource}
