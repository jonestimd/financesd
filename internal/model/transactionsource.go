...
func (ts *transactionSource) setSource(dbTransactions []*database.Transaction, err error) ([]*Transaction, error) {
	if err != nil {
		ts.err = err
		return nil, err
	}
...
func (ts *transactionSource) setDetails(details []*database.TransactionDetail, err error) {
	ts.err = err
	if err == nil {
...
func (ts *transactionSource) setRelatedDetails(details []*database.TransactionDetail, err error) {
	ts.err = err
	if err == nil {
...
func (ts *transactionSource) setRelatedTransactions(dbTransactions []*database.Transaction, err error) {
